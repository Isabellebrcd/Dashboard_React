...
import {RadialBar, Cell, AreaChart, XAxis, YAxis, Tooltip, Area, RadialBarChart} from 'recharts';
...
const MenuItem = ({imageSrc, text, text2, onClick, isOverview}) => (
    <div className={`MenuItem ${isOverview ? 'humidityItem' : 'otherItems'}`} onClick={onClick}>
    ...
    return (
        <div className="Sidebar">
            ...
            <div className="Menu">
                ...
                <MenuItem imageSrc={iconBlanc} text2="Humidity" onClick={() => navigate("/client/humidity")}
                          isOverview/>
